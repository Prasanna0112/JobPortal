...
const JobDescription = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto my-10">
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="flex gap-2 items-center mt-3">
            ...
            <Badge className="text-[#7209b7] font-bold">12LPA</Badge>
          </div>
        </div>
        <Button
          disabled={isApplied}
          className={`rounded-lg bg-black text-white cursor-pointer ${
            isApplied
      ...
      <h1 className="border-b-2 border-b-gray-300 font-medium my-3 py-3">Job Description</h1>
      <div className="my-5">
        <h1 className="font-bold my-1">Role: <span className="pl-4 font-normal text-gray-800">Frontend Developer</span></h1>
        <h1 className="font-bold my-1">Loction: <span className="pl-4 font-normal text-gray-800">Hyderabad</span></h1>
        <h1 className="font-bold my-1">Description: <span className="pl-4 font-normal text-gray-800">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Placeat, quibusdam?</span></h1>
